...
<div class="content-page">
   ...
   <div class="content">
      <div class="container">
               ...
               <div class="col-lg-2 col-md-2 col-sm-6">
                  <div class="card-box widget-box-one text-center">
                     ...
                     <div class="wigdet-one-content">
                        <p class="m-0 text-secondary" title="Statistics">Kategori</p>
            ...
            <a href="manage-posts.php">
               <div class="col-lg-2 col-md-2 col-sm-6">
                  <div class="card-box widget-box-one text-center">
                     ...
                     <div class="wigdet-one-content">
                        <p class="m-0 text-secondary" title="User This Month">Berita</p>
            ...
            <a href="manage-subcategories.php">
               <div class="col-lg-4 col-md-4 col-sm-6">
                  <div class="card-box widget-box-one text-center">
                     <i class="mdi mdi-layers widget-one-icon"></i>
                     <div class="wigdet-one-content">
                        <p class="m-0 text-secondary" title="User This Month">Sub Kategori</p>
         ...
         <div class="col-sm-12">
            <div class="card-box overflow-scroll" >
